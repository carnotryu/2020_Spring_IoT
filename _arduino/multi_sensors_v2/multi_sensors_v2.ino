...
void setup()
{
    ...
    digitalWrite(13,led);
    Wire.begin();
    Serial.begin(250000);                        // 통신속도 250000 bps
...
void serialEvent() {
  while (Serial.available())
  {
    ...
    else if (readData == '6') analogWrite(9, 0);
    else if (readData == '7') analogWrite(9, 170);
    else if (readData == '8') tone(10, 330, 1000);
    else if (readData == '9') noTone(10);
